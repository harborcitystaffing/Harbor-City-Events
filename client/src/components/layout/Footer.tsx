        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-24">
          <div className="lg:col-span-5">
            ...
            <div className="flex gap-4">
              {/* Simple luxury social links */}
              {['Instagram', 'LinkedIn', 'Facebook'].map(social => (
                <button key={social} className="text-[10px] uppercase tracking-[0.3em] font-bold text-white/60 hover:text-secondary transition-colors">
                  {social}
                </button>
              ))}
            </div>
