  ...
  return (
    <div className="min-h-screen bg-background font-sans text-foreground">
      <Helmet>
        ...
        {/* Description highlighting the specific service area */}
        <meta 
          name="description" 
        ...
        {/* Using your high-res 1280x720 image */}
        <meta property="og:image" content="https://harborcitystaffing.com/opengraph.jpg" />
        ...
        <meta name="twitter:image" content="https://harborcitystaffing.com/opengraph.jpg" />
      </Helmet>
