  ...
  return (
    <nav 
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-700 ${
        isScrolled ? "bg-white/80 backdrop-blur-md py-3 border-b border-primary/5 shadow-sm" : "bg-transparent py-6"
      }`}
    >
      <div className="container mx-auto flex items-center justify-between px-6 lg:px-12">
        {/* LOGO SECTION - SMALLER AND PULLED LEFT */}
        <div 
          className="flex items-center gap-2 cursor-pointer -ml-2 md:-ml-4 transition-all duration-300" 
        ...
        >
          ...
          />
          <div className="block">
            <span className="block text-[12px] font-bold tracking-[0.25em] uppercase leading-none text-primary">
              Harbor City
            </span>
            <span className="block text-[8px] tracking-[0.3em] uppercase text-secondary font-medium mt-1">
              Event Staffing
            </span>
          </div>
        </div>
        ...
        <div className="hidden lg:flex items-center gap-12">
          ...
          <Button 
            ...
            className="bg-primary text-white hover:bg-secondary hover:text-primary transition-all duration-500 rounded-none px-6 py-5 text-[10px] uppercase tracking-widest font-bold"
          >
            Request Quote
          </Button>
        </div>
